  ...
  return (
    <Container maxW={"7xl"} my={10} textAlign={"center"}>
      ...
      <SimpleGrid columns={3} spacing={10}>
        <Stack px={10} py={10}>
          <Image src="package1.png" width={"270px"} alt="Eco friendly package, dispose within 2 day"/>
        ...
        <Stack px={10} py={10}>
          <Image src="package2.png" width={"270px"} alt="Food lunch box"/>
        ...
        <Stack px={10} py={10}>
          <Image src="package3.png" width={"270px"} alt="Hot food in our package"/>
